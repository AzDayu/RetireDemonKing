...
public static class AESCryptoUtil
{
    ...
    private static readonly byte[] Key = Encoding.UTF8.GetBytes("OzProjectDemonKingHeroSecretKeyV");
    private static readonly byte[] IV = Encoding.UTF8.GetBytes("OzProjectInitIVV");
